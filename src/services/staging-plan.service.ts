...
class StagingPlanService {
  ...
  private buildDynamicStyleGuidance(furnitureStyle: FurnitureStyle): string {
    const profile: Record<FurnitureStyle, string> = {
      standard: `Restyle only existing furniture items in a contemporary standard style with soft rounded edges, balanced proportions, and medium-firm box cushions. Favor oak or walnut veneers, linen or cotton weaves, and brushed nickel or matte black accents. Add subtle stitch details and tone-on-tone piping, keeping the look neutral and timeless. Avoid ornate carvings, glossy glam finishes, and heavy tufting. Do not alter walls, floors, ceilings, doors, windows, or circulation paths.`,

      modern: `Restyle only existing furniture items in a modern style with clean low-profile silhouettes, rectilinear forms softened by gentle curves, and thin sled or blade legs. Apply flush-front detailing with shadow gaps, matte lacquer, powder-coated metal, smoked glass, and stone like travertine or basalt. Limited use of fluted wood accents is allowed, paired with matte black or satin chrome details. Avoid rustic textures, farmhouse cross-braces, heavy ornament, or mirror chrome. Do not alter walls, floors, ceilings, doors, windows, or circulation paths.`,

      scandinavian: `Restyle only existing furniture items in a Scandinavian style with airy minimal silhouettes, organic curves, and tapered light-wood legs in oak or beech. Use bouclé, wool, cotton, and stoneware finishes, keeping visible grain and natural textures. Accent with light neutral tones, subtle pastels, and matte black or white hardware. Avoid heavy dark woods, mirrored glam, or bulky tufted forms. Do not alter walls, floors, ceilings, doors, windows, or circulation paths.`,

      industrial: `Restyle only existing furniture items in an industrial style with robust proportions, exposed joinery, and steel or square tube frames. Favor blackened steel, raw or reclaimed wood, concrete, and oiled leather finishes. Subtle details may include visible welds, bolted brackets, and antique brass accents. Avoid delicate ornament, glossy whites, and romantic or glam features. Do not alter walls, floors, ceilings, doors, windows, or circulation paths.`,

      midcentury: `Restyle only existing furniture items in a midcentury modern style with slim boxy cushions, tapered wooden legs in walnut or teak, and rectilinear low profiles. Use linen tweed, bouclé, or fine woven fabrics with light button tufting or piping. Accents may include brass or matte black hardware and small-scale geometric motifs. Avoid oversized overstuffed seating or futuristic glossy chrome. Do not alter walls, floors, ceilings, doors, windows, or circulation paths.`,

      luxury: `Restyle only existing furniture items in a luxury style with sculptural, sumptuous silhouettes, deeply plush seating, and softly curved arms. Favor velvet, silk blends, marble, ribbed or fluted glass, and polished brass or champagne gold accents. Details may include mitered stone edges and polished reveals. Avoid rustic woods, distressed finishes, or raw industrial textures. Do not alter walls, floors, ceilings, doors, windows, or circulation paths.`,

      coastal: `Restyle only existing furniture items in a coastal style with breezy, casual silhouettes, rounded edges, and relaxed slipcovered forms. Favor rattan, jute, driftwood, bleached light woods, and linen or cotton upholstery. Accent with soft neutrals, light stripes, and open-weave details. Avoid jewel tones, heavy black metals, and glam velvets. Do not alter walls, floors, ceilings, doors, windows, or circulation paths.`,

      farmhouse: `Restyle only existing furniture items in a farmhouse style with sturdy shaker-inspired frames, natural or greige woods, and lightly textured cotton or linen fabrics. Use reclaimed or knotty wood, stoneware details, and antique bronze or black hardware. Subtle soft distressing may be included, but avoid glass-heavy tables, ultra-modern chrome, or glossy lacquer. Do not alter walls, floors, ceilings, doors, windows, or circulation paths.`,
    };
