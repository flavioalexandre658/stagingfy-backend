...
class StagingPlanService {
  ...
  private buildDynamicStyleGuidance(furnitureStyle: FurnitureStyle): string {
    const profile: Record<FurnitureStyle, string> = {
      standard: `Stylize only the existing furniture and decor items in a standard contemporary style, keeping walls, floors, ceilings, windows, doors, and architectural surfaces unchanged. Apply soft rounded edges, balanced proportions, medium-firm box cushions, oak or walnut veneers, linen or cotton weaves, and brushed nickel or matte black accents. Add subtle stitch details and tone-on-tone piping. Avoid ornate carvings, glossy glam finishes, and heavy tufting.`,

      modern: `Stylize only the existing furniture and decor items in a modern style, keeping walls, floors, ceilings, windows, doors, and architectural surfaces unchanged. Use clean low-profile silhouettes, rectilinear forms with soft curves, thin sled or blade legs, flush-front detailing with shadow gaps, matte lacquer, powder-coated metal, smoked glass, and stone (travertine/basalt). Limited fluted wood accents allowed with matte black or satin chrome details. Avoid rustic distressing, farmhouse cross-braces, heavy ornament, and glossy mirror chrome.`,

      scandinavian: `Stylize only the existing furniture and decor items in a Scandinavian style, keeping walls, floors, ceilings, windows, doors, and architectural surfaces unchanged. Emphasize airy minimal silhouettes, organic curves, and tapered light-wood legs in oak or beech. Favor bouclé, wool, cotton, and stoneware finishes with visible wood grain. Use light neutral tones with subtle pastels. Avoid dark heavy woods, mirrored glam, or oversized tufting.`,

      industrial: `Stylize only the existing furniture and decor items in an industrial style, keeping walls, floors, ceilings, windows, doors, and architectural surfaces unchanged. Apply robust proportions, exposed joinery, steel or square tube frames, blackened steel, raw or reclaimed wood, oiled leather, and concrete finishes. Subtle details may include visible welds and bolted brackets, with antique brass or blackened hardware. Avoid delicate ornament, glossy whites, or glam features.`,

      midcentury: `Stylize only the existing furniture and decor items in a midcentury modern style, keeping walls, floors, ceilings, windows, doors, and architectural surfaces unchanged. Use slim boxy cushions, loose backs, tapered walnut or teak legs, linen tweed, bouclé, and fine woven fabrics. Allow light button tufting, piping, visible finger joints, and brass or matte black accents. Avoid oversized seating or glossy futuristic chrome.`,

      luxury: `Stylize only the existing furniture and decor items in a luxury style, keeping walls, floors, ceilings, windows, doors, and architectural surfaces unchanged. Favor sculptural silhouettes, deeply plush seating, velvet, silk blends, marble, ribbed or fluted glass, and mirror accents. Include mitered stone edges, polished reveals, and metallics in polished brass or champagne gold. Avoid rustic woods, distressed finishes, or raw industrial textures.`,

      coastal: `Stylize only the existing furniture and decor items in a coastal style, keeping walls, floors, ceilings, windows, doors, and architectural surfaces unchanged. Use breezy relaxed silhouettes, rounded edges, light slipcovered forms, rattan, jute, driftwood, bleached woods, and linen or cotton upholstery. Accent with soft neutrals, subtle stripes, and brushed nickel or light bronze details. Avoid jewel tones, heavy black metals, and glam velvets.`,

      farmhouse: `Stylize only the existing furniture and decor items in a farmhouse style, keeping walls, floors, ceilings, windows, doors, and architectural surfaces unchanged. Apply sturdy shaker-inspired frames, greige or natural wood finishes, lightly textured cotton or linen, reclaimed wood, stoneware details, and antique bronze or black hardware. Subtle soft distressing may be included. Avoid glass-heavy tables, ultra-modern chrome, or glossy lacquer.`,
    };
