...
class StagingPlanService {
  ...
  private buildDynamicStyleGuidance(furnitureStyle: FurnitureStyle): string {
    const profile: Record<FurnitureStyle, string> = {
      standard: `Restyle all existing furniture and decor items in a standard contemporary style, with soft rounded edges, balanced proportions, box cushions of medium firmness, and surfaces in oak or walnut veneer with linen or cotton weaves. Use brushed nickel or matte black accents, top-stitch seams, subtle herringbone or micro-chevron textures, and tone-on-tone piping. Avoid ornate carvings, glossy glam finishes, and heavy tufting. Preserve all doors, windows, and circulation paths exactly as in the original image.`,

      modern: `Restyle all existing furniture and decor items in a modern style, replacing current forms with clean low-profile silhouettes, rectilinear structures with soft curves, thin sled or blade legs, and flush-front detailing with shadow gaps. Reinterpret only furniture surfaces using matte lacquer, powder-coated metal, smoked glass, and stone such as travertine or basalt. Incorporate fluted wood panels in limited use, with matte black or satin chrome accents. Avoid rustic distressing, farmhouse cross-braces, heavy ornament, or glossy mirror chrome. Preserve all doors, windows, and circulation paths exactly as in the original image.`,

      scandinavian: `Restyle all existing furniture and decor items in a Scandinavian style, emphasizing organic curves, airy minimal forms, and tapered light-wood legs in oak or beech. Use bouclé, wool, cotton, and stoneware finishes with visible wood grain and softly rounded corners. Keep detailing minimal with light pulls or matte black hardware, and introduce subtle striped or knit textures. Avoid dark heavy woods, mirrored glam, or oversized tufting. Preserve all doors, windows, and circulation paths exactly as in the original image.`,

      industrial: `Restyle all existing furniture and decor items in an industrial style, giving them robust proportions, exposed joinery, and square tube or steel frames. Reinterpret only furniture surfaces with blackened steel, raw or reclaimed wood, oiled leather, and concrete or stone finishes. Use visible welds and bolted brackets as subtle details, and accent with antique brass or blackened hardware. Avoid delicate ornament, glossy whites, or romantic/glam cues. Preserve all doors, windows, and circulation paths exactly as in the original image.`,

      midcentury: `Restyle all existing furniture and decor items in a midcentury modern style, using slim profiles, boxy cushions, loose backs, and tapered wooden legs in walnut or teak. Apply linen tweed, bouclé, or fine woven textiles with light button tufting and piping. Include visible finger joints and brass or matte black accents, with geometric or atomic-inspired motifs in small scale. Avoid oversized overstuffed seating or glossy futuristic chrome. Preserve all doors, windows, and circulation paths exactly as in the original image.`,

      luxury: `Restyle all existing furniture and decor items in a luxury style, with sculptural sumptuous silhouettes, deeply plush seating, and softly curved arms. Use rich furniture surfaces in velvet, silk blends, marble, ribbed or fluted glass, and mirror accents. Incorporate mitered stone edges, polished reveals, and metallics in polished brass or champagne gold. Avoid rustic or distressed materials and industrial roughness. Preserve all doors, windows, and circulation paths exactly as in the original image.`,

      coastal: `Restyle all existing furniture and decor items in a coastal style, with breezy casual silhouettes, rounded edges, and light relaxed forms. Reinterpret materials using rattan, jute, driftwood, and washed or bleached woods with linen or cotton upholstery. Add details like loose slipcovers, open-weave textures, and brushed nickel or light bronze accents. Avoid dark jewel tones, velvet glam, or heavy black metal. Preserve all doors, windows, and circulation paths exactly as in the original image.`,

      farmhouse: `Restyle all existing furniture and decor items in a farmhouse style, using sturdy shaker-inspired frames, greige or natural wood finishes, and reclaimed or knotty wood textures. Apply stoneware, textured cotton, and linen fabrics with visible grain and light soft distressing. Include black or antique bronze hardware and simple woven or basket weave details. Avoid glass-heavy tables, ultra-modern chrome, or high-gloss lacquer. Preserve all doors, windows, and circulation paths exactly as in the original image.`,
    };
